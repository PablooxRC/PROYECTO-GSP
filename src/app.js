...
import { rateLimitMiddleware, strictRateLimitMiddleware } from './utils/rateLimiter.js';
...
app.post('/api/signin', strictRateLimitMiddleware, validateSchema(signinSchema), signin);
app.post('/api/signup', strictRateLimitMiddleware, validateSchema(signupSchema), signup);
