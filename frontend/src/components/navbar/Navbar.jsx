        ...
        <nav className="bg-white border-b-2 border-gray-100 dark:bg-gray-900 dark:border-gray-700 shadow-sm">
          <div className="max-w-screen-xl flex items-center justify-between mx-auto px-4 py-3">
            ...
            <a href="/" className="flex items-center gap-2 flex-shrink-0">
                <img src="https://i.ibb.co/8gHKQbF6/Grupo-Scout-Panda.png" className="h-10 w-10" alt="Logo Scout Panda" />
                <span className="text-lg font-bold text-gray-900 dark:text-white whitespace-nowrap">Scout Panda</span>
            </a>
