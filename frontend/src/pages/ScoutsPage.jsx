...
function ScoutPage(){
  ...
  // Función para imprimir reporte con todos los scouts
  ...
  return (
    <div>
      <div>
        <h1 className="text-4xl font-extrabold dark:text-white py-4">Unidad: {user?.unidad || "No disponible"}</h1>
      </div>

      {/* Botón para imprimir reporte */}
      <div className="mb-4">
        <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={handlePrintReport}>
